...
//   // ฟังก์ชันดึงข้อมูลจำนวนสินค้าในตะกร้าจาก database
//   useEffect(() => {
//     const countCartItems = async () => {
//       try {
//         const response = await axios.get(`http://localhost:3000/cart/count/${user.user.id}`, {
//           headers: {
...
//         setCount(totalCount); // อัพเดทค่า count ใน state
//       } catch (error) {
//         console.error("Error fetching cart item count:", error);
//       }
//     };

//     // เรียกฟังก์ชันเมื่อมีการเปลี่ยนแปลงคำสั่งซื้อหรือจำนวนสินค้าของผู้ใช้
//     if (user && user.user && user.user.id) {
//       countCartItems();
//     }
//   }, [user, orders, count]); // ฟังการเปลี่ยนแปลงของ user, orders, และ count
